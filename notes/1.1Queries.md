...
Same query but selecting only a,b fields, by default _id is always returned, you need to exclude it specifically
...
[json](https://storage.googleapis.com/ansp-mongo-workshop/mongo/compass/agenda.json)
...
4.4 Find all presentations having exactly 2 comments
